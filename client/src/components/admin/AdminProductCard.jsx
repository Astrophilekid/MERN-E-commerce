...
import HomeProductSkelton from '../HomeProductSkelton'
...
const AdminProductCard = ({ product, pageLoading, modal, setModal }) => {
  ...
  return (
    ...
    >
      ...
      <Link
        to={`/product/${_id}`}
        className="h-full flex justify-center items-center sm:flex-col"
      >
        <div className="relative mx-3 mt-3 max-sm:w-2/5 flex justify-center h-52 sm:h-60 overflow-hidden rounded-xl ">
